...
interface BhajanTabContentProps {
  filter: DeityFilterSelection;
}

// Same shape as RingtonesTabContent/AartiTabContent - FlatList wrapper with
  ...
  return (
    <FlatList
      ...
      contentContainerStyle={[{ paddingBottom: contentPadding },
        styles.listContent,
        bhajans.length === 0 && styles.emptyContainer,
      ]}
      refreshControl={
        <RefreshControl
